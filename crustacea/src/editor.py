...
class EditorScreen(Screen):
    ...
    def compose(self) -> app.ComposeResult:
        ...
        # Create text area with language validation
        # If language is invalid, fall back to no syntax highlighting
        try:
            if self.language:
            ...
            # Language not available, create without syntax highlighting
            self.text_area = edit.CrustaceaTextArea.code_editor(
                text=self.input_text,
                theme="vscode_dark"
            )
